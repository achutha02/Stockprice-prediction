...
def predict():
    ...
    def AdaBoost_ALG(df):
        ...
        model = AdaBoostRegressor(base_estimator=base_estimator, n_estimators=100, learning_rate=0.1, random_state=0)
        ...
        error_adaboost = math.sqrt(mean_squared_error(real_stock_price, predicted_stock_price))
        ...
        adaboost_pred = forecasted_stock_price[0, 0]
        
        print()
        print("##############################################################################")
        print("Tomorrow's ", quote, " Closing Price Prediction by AdaBoost: ", adaboost_pred)
        print("AdaBoost RMSE:", error_adaboost)
        print("##############################################################################")
        
        return adaboost_pred, error_adaboost
    ...
    try:
        ...
        gru_pred,error_gru=AdaBoost_ALG(df)
